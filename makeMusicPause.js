...
let pausePlay = document.getElementById('toggleMusic')
...
backgroundMusic.loop = true;
backgroundMusic.autoplay = false;
    if (backgroundMusic.autoplay === true){
        backgroundMusic.pause()
        return backgroundMusic.autoplay = false
    }
    if(backgroundMusic.autoplay === false){
        backgroundMusic.play()
       return backgroundMusic.autoplay = true
    }
})
